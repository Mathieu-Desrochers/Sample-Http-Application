    ...
    public class NewSessionOperationTests
    {
        ...
        private void ShouldThrowInvalidSessionCodeErrorCode(string sessionCode)
        {
            ...
            catch (AggregateException ex)
            {
                ...
                Assert.AreEqual("The SchedulingBusinessLogicComponent.NewSession operation returned the InvalidSessionCode error code.", newSessionBusinessException.Message);
            }
        }
        ...
        public void ShouldThrowDuplicateSessionCodeErrorCode()
        {
            ...
            catch (AggregateException ex)
            {
                ...
                Assert.AreEqual("The SchedulingBusinessLogicComponent.NewSession operation returned the DuplicateSessionCode error code.", newSessionBusinessException.Message);
            }
        }
        ...
        private void ShouldThrowInvalidNameErrorCode(string name)
        {
            ...
            catch (AggregateException ex)
            {
                ...
                Assert.AreEqual("The SchedulingBusinessLogicComponent.NewSession operation returned the InvalidName error code.", newSessionBusinessException.Message);
            }
        }
